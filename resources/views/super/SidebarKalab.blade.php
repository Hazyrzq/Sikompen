        ...
        <nav class="flex flex-col flex-grow pt-9">
            <div class="px-4 pb-5">
                <a href="{{ route('kalab.listpengajuan') }}" 
                   class="{{ request()->routeIs('kalab.listpengajuan') ? 'bg-emerald-50 text-emerald-600' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }} flex items-center h-10 px-4 rounded-lg transition-all duration-200 group mb-2">
                ...
                <a href="{{ route('kalab.listdisetujui') }}"
                   class="{{ request()->routeIs('kalab.listdisetujui') ? 'bg-emerald-50 text-emerald-600' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }} flex items-center h-10 px-4 rounded-lg transition-all duration-200 group mb-2">
                    <div class="w-5 flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
